 ...
 * <p>
 * Throws an exception to be caught by the UnhandledExceptionHandler.
 */
class ThrowExceptionLuaFunction implements com.naef.jnlua.NamedJavaFunction {
	/**
	...
	public int invoke(com.naef.jnlua.LuaState luaState) {
		...
		dispatcher.send(new com.ansca.corona.CoronaRuntimeTask() {
			...
			public void executeUsing(com.ansca.corona.CoronaRuntime runtime) {
				String test = null;
				//noinspection RedundantStringToString,ConstantConditions,ResultOfMethodCallIgnored
				test.toString();
			}
		});
		return 0;
