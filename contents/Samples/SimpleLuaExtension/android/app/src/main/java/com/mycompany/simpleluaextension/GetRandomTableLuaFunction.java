 ...
 */
class GetRandomTableLuaFunction implements com.naef.jnlua.NamedJavaFunction {
	/**
	...
	public int invoke(com.naef.jnlua.LuaState luaState) {
		...
		java.util.Hashtable<String, Double> hashtable = new java.util.Hashtable<>();
		hashtable.put("x", randomizer.nextDouble());
		hashtable.put("y", randomizer.nextDouble());
		hashtable.put("z", randomizer.nextDouble());
		...
		for (java.util.Map.Entry<String, Double> entry : hashtable.entrySet()) {
			...
			luaState.pushNumber(entry.getValue());
